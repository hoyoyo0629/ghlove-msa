...
/**
 * AS-IS components/ui/lclgv_chc/map.vue의 lclgvUpperList 재현 - "지자체별 검색" 지도
 * 팝업의 시/도 배치 메타데이터(좌표 클래스·강조 지도 이미지). order 서비스의 "지자체몰
 * 선택하기" 팝업(LocgovMapProvince.java)과 동일한 데이터 - 서비스마다 자체 DB만 갖는
 * 구조라 공유 라이브러리 없이 각자 복제해서 둔다.
 */
